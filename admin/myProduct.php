                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        echo "<td style='text-align: center'>";
                                            echo '<a href="./editProduct.php?productID='. $row['productID'] .'" class="mr-3" title="Update" data-toggle="tooltip"><span class="fa fa-pencil"></span></a>';
                                            echo "&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp";
                                            echo '<a href="./deleteProduct.php?productID='. $row['productID'] .'" title="Delete" data-toggle="tooltip"><span class="fa fa-trash"></span></a>';
                                                                              echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";
