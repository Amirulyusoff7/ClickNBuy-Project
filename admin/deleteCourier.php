...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if($result){
    echo '<script type="text/javascript">alert("Courier deleted successfully !");window.location.href = "viewCourier.php";</script>';
    } else {
...
<div class="container">
<p>Courier Form</p>
<form name="courierForm" id="courierForm" method="post" action="deleteCourier.php">  
  <?php 
