                            ...
                            echo '<table id= "table_id" class="table table-striped table-bordered ">';
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        // echo "<td>" . $row['pin'] . "</td>";
                                        echo "<td>";
                                            echo '<a href="updateSeller.php?sellerID='. $row['customerID'] .'" class="mr-3" title="Update Record" data-toggle="tooltip"><span class="fa fa-pencil"></span></a>';
                                            echo '<a href="deleteSeller.php?sellerID='. $row['customerID'] .'" title="Delete Record" data-toggle="tooltip"><span class="fa fa-trash"></span></a>';
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";
