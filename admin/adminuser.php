                            ...
                            echo '<table id= "table_id" class="table table-striped table-bordered ">';
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        echo "<td>";
                                            echo '<a href="./updateAdmin.php?adminID='. $row['adminID'] .'" class="mr-3" title="Update Record" data-toggle="tooltip"><span class="fa fa-pencil"></span></a>';
                                            echo '<a href="./deleteAdmin.php?adminID='. $row['adminID'] .'" title="Delete Record" data-toggle="tooltip"><span class="fa fa-trash"></span></a>';
                                                                              echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";
