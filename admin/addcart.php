...
<h2>In Cart</h2>
  <div align="center">
            ...
            <tr><th> Name </th></tr>
            <tr><th> Variation 1 </th></tr>
            <tr><th> Variation 2 </th></tr>
            <tr><th>Price per</th></tr>
...
<tr>
           ...
           <td><a onclick="return confirm('Are you sure you want to delete?')" href="delrowcart.php?id=<?php echo $item['cartID']; ?>">Delete</a>||<a href="cartedit.php?id=<?php echo $item['cartID']; ?>">Edit</a>
 </tr>
<br>
...
<?php  
 ...
 <br>
 <form>
 <a href="checkconfirm.php?customerid=<?php echo $cusID?>" name ="select" class="btn btn-primary btn-sm">View</a>
