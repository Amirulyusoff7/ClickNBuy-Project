...
if($_SERVER["REQUEST_METHOD"]=="POST"){
    ...
    $sql = "INSERT INTO address (name, phoneNo, houseNo, streetName, city, postcode, customerID) VALUES ('$name', '$phoneNo', '$houseNo', '$streetName', '$city', '$postcode', '$cusID')";
   mysqli_query($conn,$sql);
   echo "<script>alert('Insert Successful');document.location='checkconfirm.php'</script>";
