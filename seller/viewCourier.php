                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        echo "<td style='text-align: center'>";
                                            echo '<a href="../seller/editCourier.php?courierID='. $row['courierID'] .'" class="mr-3" title="Update courier" data-toggle="tooltip"><span class="fa fa-pencil"></span></a>';
                                            echo "&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp";
                                            echo '<a href="../seller/deleteCourier.php?courierID='. $row['courierID'] .'" title="Delete courier" data-toggle="tooltip"><span class="fa fa-trash"></span></a>';
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";
