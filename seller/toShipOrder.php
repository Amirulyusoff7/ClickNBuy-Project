   ...
   <script>
        var orderID1;
            function changeWindow(orderID1) {
                window.location.href = "../seller/deliveryForm.php?orderID1=" + orderID1;
            }
             ...
             <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="orderHeader">
                        <a href="../seller/manageOrder.php" class="link-primary">All</a>&nbsp&nbsp
                                            ...
                                            if($i<1) {
                                                ...
                                                if($row['orderStatus']=="To ship"){
                                                    if($product['paymentStatus']=="Paid") {
                                                        // echo "<td rowspan='$count'><input type='button' name='btn-ship' value='Ship parcel' onclick='window.open(\"../seller/deliveryForm.php?orderID1=".$row['orderID']." \", \"Ship Parcel\", \"height=600,width=800\")'></td>";
